					...
					<div className='flex justify-between'>
						{code.map((digit, index) => (
							<input
								...
								className='w-12 h-12 text-center text-2xl font-bold bg-blue-700 text-white border-2 border-blue-600 rounded-lg focus:border-cyan-500 focus:outline-none'								/>
						))}
					</div>
